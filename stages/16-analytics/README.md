...
6. [06 — AI Reports *(Pro)*](06-ai-reports-pro.md) — Verify both AI report pages, deterministic data, connector guidance, Pro ownership, and Pro-deactivation behavior.

**Exit criteria:**
- Reports Hub renders 13 categories and 49 report cards, including AI Reports as Pro, with correct summary counts and quick-nav behavior.
...
- AI Churn Analysis and AI Revenue Forecast load only while ArraySubsPro is active; their deterministic metrics remain available when no AI connector is configured, and the pages disappear cleanly when Pro is inactive.
