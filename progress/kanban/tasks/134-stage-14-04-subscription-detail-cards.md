...
Issue #103 fixed: cancelled subscription detail Skip & Pause > Vacation Mode now says 'Subscription is cancelled' instead of active. Verified on #508 with Alumnium + Playwright. Screenshot qa/artifacts/issue-103-cancelled-vacation-mode.png.
