...
Fix verification 2026-05-24 for issue #90: Subscriptions admin list now renders five documented headers in order: Status, Date, Customer, Product, Next Payment. Title is removed from this screen only; row hover actions remain available under the first visible column. Playwright extracted first_row_actions='View Details|Edit|Delete'. Screenshot: qa/artifacts/issue-90-subscriptions-columns.png. Build: npm run build passed.
