...
Issue #116 fixed: Subscription Charts now have manual Day/Week/Month/Quarter/Year controls. Verified build, agent-browser interval state, and agent-browser REST calls for all intervals; screenshot qa/artifacts/issue-116/chart-interval-year-selected.png.
