...
Observed with agent-browser on 2026-05-20 for Trial Weekly #202. Checkout summary showed recurring '9.99 Every week', free trial '7 days', total '/bin/bash.00', payment methods visible. Expected Stage 03 task 02.5 also requires next charge date 7 days in future and authorization notice beginning 'By completing this purchase, you authorize us to charge'. Actual: next charge date not visible; notice text is generic 'By proceeding with your purchase you agree to our Terms and Conditions and Privacy Policy'.
