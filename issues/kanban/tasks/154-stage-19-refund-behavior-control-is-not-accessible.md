...
Fix: Refund on Cancellation now uses existing FormBuilder Radio instead of custom Select. Built arraysubs admin assets. Verified with agent-browser accessibility tree: three native radios exposed; agent-browser selected Refund at End of Period. Verified with agent-browser role selector and screenshot: qa/artifacts/issue-154/refund-settings-radio-group-eop-selected.png; proof endOfPeriod=true, immediate=false, none=false.
