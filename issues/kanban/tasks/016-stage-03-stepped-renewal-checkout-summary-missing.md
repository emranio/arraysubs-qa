...
Observed with agent-browser on 2026-05-20 for Stepped Weekly #209. Product/admin tier fields persisted; product page and cart showed both initial 9.99 and later 9.99 after 3 cycles/renewals. Checkout summary showed 'After 3 renewals: 9.99 Every week' and today's charge 9.99, but no next charge date. Expected Stage 03 task 04.5: next charge date approximately one week away.
