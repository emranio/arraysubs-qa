...
Fixed: core wp-admin top-level menu title now ArraySubs in MainAdmin Hooks. Verified php -l and Alumnium admin sidebar labels: Dashboard, Posts, ..., ArraySubs, WooCommerce...
