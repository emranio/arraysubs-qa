...
Fixed: BaseSubscriptionEmail now supplies realistic preview fallback args and preserves child placeholders. New Subscription, Trial Started, and Admin New Subscription templates now render display args instead of empty get_post_meta(0) values; plain footers now run through email placeholder formatting. Alumnium verified all three Woo previews show sample subscription/customer/product/price/dates and no literal {site_title}, {store_address}, Product N/A, #0, or /bin/bash.00 fallback.
