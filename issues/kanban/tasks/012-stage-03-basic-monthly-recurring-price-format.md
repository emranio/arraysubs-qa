...
Observed with agent-browser on 2026-05-20 for product #197 Basic Monthly. Product detail displays '9.99 Every month' and extra 'Shipping charged on every renewal'; shop catalog card displays only '9.99'. Expected Stage 03 task 01: '9.99 / month' on product page and catalog, with no extra trial/signup/first-payment text. Add-to-cart/Subscribe button is visible.
