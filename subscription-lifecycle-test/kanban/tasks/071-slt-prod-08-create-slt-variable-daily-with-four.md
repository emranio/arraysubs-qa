...
Failure closeout on Thursday, August 6, 2026. Live admin creation flow produced parent product 13012 and four intended child variations (13013, 13015, 13017, 13019), but all landed in post_status=trash and reopening /wp-admin/post.php?post=13012&action=edit returned a WordPress admin error. Standalone issue filed: qa/subscription-lifecycle-test/issues/done-critical-plugin-SLT-PROD-08-variable-subscription-draft-is-trashed-on-save.md. Evidence: /home/server-manager/slt-evidence/SLT-PROD-08-01-attributes.png and /home/server-manager/slt-evidence/SLT-PROD-08-07-edit-error.png.

[[2026-08-13]] Thu 08:45
Issue resolution: retained audit/binlog data proves all four variations and parent settings saved successfully, followed approximately 48 seconds later by a separate canonical WordPress/WooCommerce trash request. A fresh live editor control saved, generated four variations, ran Save changes, saved the draft again, and reloaded normally with no trash metadata. The report was closed as a false-positive save-path attribution; no production code changed. The marked control and its exact notes/actions were removed with zero residue.
