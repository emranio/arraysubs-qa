...
- Product observations are isolated in `issues/critical-plugin-SLT-OBS-01-duplicate-gateway-postmeta-rows.md` and `issues/light-plugin-SLT-CHK-01-wc-blocks-data-dependency-warning.md`; neither blocks this functional pass.
